    ...
    for epoch in range(epochs):
        ...
        for inputs, labels in batches:
            ...
            for label, data_group in grouped_inputs.items():
                ...
                X = neuron_space_strategy(model, tf_data)  # Inputs all batch, with labels X = inputs
                ...
                with tf.GradientTape() as tape:
                    ...
                    predictions_point = _compute_predictions(tf_data, model)  # tf_data
        ...
        for validation_inputs, validation_labels in val_dataset:
            val_loss = loss_object(validation_labels,
                                   _compute_predictions(validation_inputs, model)).numpy()
